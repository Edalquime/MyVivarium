...
// Cambiar a 1 temporalmente si necesitas ver errores exactos de PHP en pantalla
            ...
            <table class="actual-card">
                ...
                <tr>
                    ...
                    <td rowspan="4" style="width: 20%; text-align:center; padding: 2px;">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://<?= $url ?>/bc_view.php?id=<?= $breedingcage["cage_id"] ?>&choe=UTF-8" alt="QR" style="display:block; margin: 0 auto; max-width: 90px; height: 90px;">
                    </td>
                </tr>
