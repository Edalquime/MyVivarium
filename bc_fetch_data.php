...
/**
 * Script de Paginación y Búsqueda de Jaulas de Cruce (o Holding)
 *
 * Este script maneja la paginación y la funcionalidad de búsqueda asíncrona.
 * Devuelve un JSON con las filas de la tabla y los botones de paginación.
 */

// Iniciar una nueva sesión o reanudar la existente
session_start();

// Desactivar la visualización de errores en producción (se registran en los logs del servidor)
...
// ⚠️ NOTA: Si este buscador es para el Dashboard de Mantenimiento (HC), 
// cambia "breeding" por "holding" en las 4 consultas SQL de abajo.
...
if ($result && $result->num_rows > 0) {
    // CORRECCIÓN AQUÍ: Usamos ->fetch_assoc() en lugar de mysqli_fetch_assoc() para compatibilidad
    ...
    // Texto de "sin resultados" en español
...
// Enviamos la respuesta limpia en formato JSON
